...
verify-staging-freecom: download-staging-freecom
	...
	com082pl3.zip) ${MAKE} -f $(firstword $(MAKEFILE_LIST)) download-verify FILE=${COMMAND_ZIPFILE} EXPECTED_CHECKSUM=0e2e501d1f9d8ffa9bdbbd08b019f2a4 ;; \
	com082pl3-xmsswap.zip) ${MAKE} -f $(firstword $(MAKEFILE_LIST)) download-verify FILE=${COMMAND_ZIPFILE} EXPECTED_CHECKSUM=48cfb02bc87aa0e2deb73b8f5ae30653 ;; \
	*) exit 1 ;; \
	esac
